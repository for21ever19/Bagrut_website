export default function SubjectContent() {
  return (
    <div className="prose prose-stone prose-lg max-w-none">
      ...
      <h2 id="chapter-1">Глава 1: Введение</h2>
      <p>
      ...
      <h2 id="chapter-2">Глава 2: Основные понятия</h2>
      <p>
      ...
      <h2 id="chapter-3">Глава 3: Практические примеры</h2>
      <p>
      ...
      <h2 id="chapter-4">Глава 4: Заключение</h2>
      <p>
